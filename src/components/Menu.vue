<template>
  <nav class="navbar navbar-expand-lg navbar-dark primary-color" v-bind:class="homeMenu">
    <router-link class="navbar-brand" to="/">
      <img height="50" src="/assets/img/logo/logo.png">
    </router-link>
    <!-- Collapse button -->
...
<script>
  export default {
    ...
    computed: {
      homeMenu: function () {
        return (this.$route.path === "/") ? 'home-menu' : null
      }
    }
  }
</script>
